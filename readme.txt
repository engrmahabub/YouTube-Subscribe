...
4. Also you have SM YouTube Subscribe in settings section for YouTube Subscribe Button.

= Usage =

1. Go to Appearance > Widgets.
2. Enable SM YouTube Subscribe widget.
...
1. YouTube Subscribe widget settings
...
= 1.0.0 =
* Create Widget for YouTube Subscription Button named SM Youtube Subscribe
